...
public class Course {
    ...
    public List<Student> studentList() {
        ...
        String findStudentListSql = "SELECT * FROM student AS s INNER JOIN student_course as cs ON s.id = cs.student_id " +
                "WHERE cs.course_id = ?";
        Object[] args = {
            this.id
        };
